...
template <typename Scalar, Index RowsAtCompileTime, Index ParamsAtCompileTime>
template <typename F, typename BC, typename FJ, typename BCJ, typename Derived1, typename Derived2, typename Derived3, typename Derived4>
auto bvp6c<Scalar, RowsAtCompileTime, ParamsAtCompileTime>::solve(F& fun, BC& bc, FJ& fun_jac, BCJ& bc_jac, const ArrayBase<Derived1>& x, const ArrayBase<Derived2>& y, const ArrayBase<Derived3>& p, const MatrixBase<Derived4>& S, Scalar tol, Scalar bc_tol, int max_nodes) -> BVP_Result<MethodS<F, BC, FJ, BCJ>> {
...
template <typename Scalar, Index RowsAtCompileTime, Index ParamsAtCompileTime>
template <typename F, typename BC, typename FJ, typename BCJ, typename Derived1, typename Derived2, typename Derived3>
auto bvp6c<Scalar, RowsAtCompileTime, ParamsAtCompileTime>::solve(F& fun, BC& bc, FJ& fun_jac, BCJ& bc_jac, const ArrayBase<Derived1>& x, const ArrayBase<Derived2>& y, const ArrayBase<Derived3>& p, Scalar tol, Scalar bc_tol, int max_nodes) -> BVP_Result<Method<F, BC, FJ, BCJ>> {
...
template <typename Scalar, Index RowsAtCompileTime, Index ParamsAtCompileTime>
template <typename F, typename BC, typename Derived1, typename Derived2, typename Derived3, typename Derived4>
auto bvp6c<Scalar, RowsAtCompileTime, ParamsAtCompileTime>::solve(F& fun, BC& bc, const ArrayBase<Derived1>& x, const ArrayBase<Derived2>& y, const ArrayBase<Derived3>& p, const MatrixBase<Derived4>& S, Scalar tol, Scalar bc_tol, int max_nodes) -> BVP_Result<MethodSE<F, BC>> {
  using SType = Matrix<Scalar, RowsAtCompileTime, RowsAtCompileTime>;
  SType B = SType::Identity(S.rows(), S.cols()) - S.completeOrthogonalDecomposition().pseudoInverse() * S;
  const_cast<ArrayBase<Derived2>&>(y).col(0).matrix() = B * y.col(0).matrix();
...
template <typename Scalar, Index RowsAtCompileTime, Index ParamsAtCompileTime>
template <typename F, typename BC, typename Derived1, typename Derived2, typename Derived3>
auto bvp6c<Scalar, RowsAtCompileTime, ParamsAtCompileTime>::solve(F& fun, BC& bc, const ArrayBase<Derived1>& x, const ArrayBase<Derived2>& y, const ArrayBase<Derived3>& p, Scalar tol, Scalar bc_tol, int max_nodes) -> BVP_Result<MethodE<F, BC>> {
...
template <typename Scalar, Index RowsAtCompileTime>
template <typename F, typename BC, typename FJ, typename BCJ, typename Derived1, typename Derived2, typename Derived3>
auto bvp6c<Scalar, RowsAtCompileTime, 0>::solve(F& fun, BC& bc, FJ& fun_jac, BCJ& bc_jac, const ArrayBase<Derived1>& x, const ArrayBase<Derived2>& y, const MatrixBase<Derived3>& S, Scalar tol, Scalar bc_tol, int max_nodes) -> BVP_Result<MethodS<F, BC, FJ, BCJ>> {
  using SType = Matrix<Scalar, RowsAtCompileTime, RowsAtCompileTime>;
  SType B = SType::Identity(S.rows(), S.cols()) - S.completeOrthogonalDecomposition().pseudoInverse() * S;
  const_cast<ArrayBase<Derived2>&>(y).col(0).matrix() = B * y.col(0).matrix();
  SType D = (SType::Identity(S.rows(), S.cols()) - S).completeOrthogonalDecomposition().pseudoInverse();
...
template <typename Scalar, Index RowsAtCompileTime>
template <typename F, typename BC, typename FJ, typename BCJ, typename Derived1, typename Derived2>
auto bvp6c<Scalar, RowsAtCompileTime, 0>::solve(F& fun, BC& bc, FJ& fun_jac, BCJ& bc_jac, const ArrayBase<Derived1>& x, const ArrayBase<Derived2>& y, Scalar tol, Scalar bc_tol, int max_nodes) -> BVP_Result<Method<F, BC, FJ, BCJ>> {
...
template <typename Scalar, Index RowsAtCompileTime>
template <typename F, typename BC, typename Derived1, typename Derived2, typename Derived3>
auto bvp6c<Scalar, RowsAtCompileTime, 0>::solve(F& fun, BC& bc, const ArrayBase<Derived1>& x, const ArrayBase<Derived2>& y, const MatrixBase<Derived3>& S, Scalar tol, Scalar bc_tol, int max_nodes) -> BVP_Result<MethodSE<F, BC>> {
  using SType = Matrix<Scalar, RowsAtCompileTime, RowsAtCompileTime>;
  SType B = SType::Identity(S.rows(), S.cols()) - S.completeOrthogonalDecomposition().pseudoInverse() * S;
  const_cast<ArrayBase<Derived2>&>(y).col(0).matrix() = B * y.col(0).matrix();
  SType D = (SType::Identity(S.rows(), S.cols()) - S).completeOrthogonalDecomposition().pseudoInverse();
...
template <typename Scalar, Index RowsAtCompileTime>
template <typename F, typename BC, typename Derived1, typename Derived2>
auto bvp6c<Scalar, RowsAtCompileTime, 0>::solve(F& fun, BC& bc, const ArrayBase<Derived1>& x, const ArrayBase<Derived2>& y, Scalar tol, Scalar bc_tol, int max_nodes) -> BVP_Result<MethodE<F, BC>> {
