...
public:
  ...
  m_residues{m_rows * m_cols + m_params}, m_residuals{m_cols - 1},
  ...
  x{m_x}, h{m_h}, y{m_y}, f{m_f}, residues{m_residues}, residuals{m_residuals}, jacobian{m_jacobian},
  ...
  m_y{y_input},
  m_f{m_fun(m_x, m_y)},
  m_residues{m_rows * m_cols}, m_residuals{m_cols - 1},
...
protected:
  ...
  Array<Scalar, IntervalsAtCompileTime, 1> m_residuals;
